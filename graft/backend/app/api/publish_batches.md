...
- create_publish_batch · function · L159-L230 — async def create_publish_batch( data: PublishTaskAssignRequest, db: AsyncSession = Depends(get_db), current_user: Annotated[User, Depends(get_current_user)] = None, )
