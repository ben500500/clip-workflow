...
- get_multi_operator_verification · function · L169-L179 — async def get_multi_operator_verification( current_user: Annotated[User, Depends(get_current_user)] = None, )
- set_multi_operator_flag · function · L183-L191 — async def set_multi_operator_flag( enabled: bool = Body(..., embed=True, description="灰度开关 MULTI_OPERATOR_ENABLED"), current_user: Annotated[User, Depends(get_current_user)] = None, )
