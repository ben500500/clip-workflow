# frontend/src/api/wechatDl.ts

- WechatDlTask · interface · L3-L20 — interface WechatDlTask
- WechatDlTaskList · interface · L22-L25 — interface WechatDlTaskList
- WechatDlImportResult · interface · L27-L33 — interface WechatDlImportResult
- WechatDlBatchImportResult · interface · L35-L41 — interface WechatDlBatchImportResult
