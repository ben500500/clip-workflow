...
- TextOverlayItem · interface · L20-L28 — Describes a fixed text overlay (no image upload needed) to be rendered at a position on the output video with optional font/color/border styling.
- SubtitleUploadResult · interface · L30-L35 — Result payload returned after uploading a subtitle file, carrying the file metadata and upload id.
